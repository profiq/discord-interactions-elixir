defmodule DiscordInteractions.EmbedTest do
  ...
  describe "new/1" do
    ...
    test "creates an embed with initial values" do
      assert %{title: "Hello", description: "World"} = Embed.new(title: "Hello", description: "World")
    end
  end
  ...
  describe "description/2" do
    test "sets the description" do
      embed = Embed.new()
      assert %{description: "This is a description"} = Embed.description(embed, "This is a description")
    end
  end
  ...
  describe "footer/3" do
    ...
    test "sets the footer with all parameters" do
      ...
      } = Embed.footer(embed, "Footer text", "https://example.com/icon.png", "https://proxy.example.com/icon.png")
    end
  end
  ...
  describe "author/5" do
    ...
    test "sets the author with name, url, and icon_url" do
      ...
      } = Embed.author(embed, "John Doe", "https://example.com", "https://example.com/icon.png")
    end
    ...
    test "sets the author with all parameters" do
      ...
      } = Embed.author(embed, "John Doe", "https://example.com", "https://example.com/icon.png", "https://proxy.example.com/icon.png")
    end
  end
